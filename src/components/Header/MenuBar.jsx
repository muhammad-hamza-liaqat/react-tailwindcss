...
export default function MenuBar () {
  const handleIconClick = (iconName) => {
    console.log(`${iconName} clicked`); // Replace this with your desired action
  };
